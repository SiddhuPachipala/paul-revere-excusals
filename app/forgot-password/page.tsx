...
export default async function ForgotPasswordPage({
  ...
  return <main className="loginwrap">
    <section className="login-intro" aria-labelledby="reset-request-title">
      ...
      <h1 id="reset-request-title">Account recovery</h1>
    </section>
    <section className="login" aria-label="Password recovery">
      <div className="login-card stack">
        <header className="login-card-head"><div><h2>Reset password</h2><p>We’ll email you a secure, one-time reset link.</p></div></header>
