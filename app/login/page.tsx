      ...
      <details className="signup-drawer"><summary>New cadet? <span>Create an account</span></summary>
          <form action={signup} className="stack" style={{marginTop:14}}>
            ...
            <div className="formgrid">
              <label><span className="label">Company</span><select className="field" name="company" defaultValue="" required><option value="" disabled>Select company</option><option value="A">A Company</option><option value="B">B Company</option></select></label>
